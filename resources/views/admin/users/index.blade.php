<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.users.create') }}" class="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 font-medium">
                Add User
            </a>
        </div>
    </x-slot>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <a href="{{ route('admin.users.edit', $user->user_id) }}" class="text-blue-600 hover:underline mr-3">Edit</a>
