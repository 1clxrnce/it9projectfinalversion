<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">{{ __('Create Brand') }}</h2>
    </x-slot>
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.brands.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="brand_name" id="brand_name" value="{{ old('brand_name') }}" required class="w-full bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm">
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="flex gap-4">
                            <button type="submit" class="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 font-medium transition-colors">Create Brand</button>
