<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-300 bg-gray-700 hover:text-white hover:bg-gray-600 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('home')" class="flex items-center gap-2">
            ...
            @if(Auth::user()->isStaff() || Auth::user()->isAdmin())
                <div class="pt-2 pb-2 border-t border-gray-700">
                    <div class="px-4 py-2 text-xs font-semibold text-gray-400 uppercase">{{ __('Admin') }}</div>
                    @if(Auth::user()->isAdmin())
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            <div class="px-4">
                <div class="font-medium text-base text-white">{{ Auth::user()->firstName }} {{ Auth::user()->lastName }}</div>
